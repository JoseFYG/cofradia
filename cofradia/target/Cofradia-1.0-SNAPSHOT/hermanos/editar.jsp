    ...
    <body style="background-color: #F39237;">
        ...
        <section class="mt-3 mx-5">
            <div class="card" style="width: 80%; margin: auto auto;">
                <form action="../hermanos/editar.jsp?id=<%=request.getParameter("id")%>" method="post">
                    <%                        try {
                    ...
                    <ul class="list-group list-group-light list-group-small">
                        ...
                        <li class="list-group-item px-3 py-3">
                            <div class="form-group">
                                ...
                                %>
                                <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" value="<%=fecha%>">
                            </div>
                        </li>
                        <li class="list-group-item px-3 py-3">
                            <div class="form-group">
                        ...
                        <li class="list-group-item px-3 text-center">
                            <button type="submit" name="editar" class="btn btn-success px-5 py-3"><i class="fa-solid fa-floppy-disk mx-1"></i> Editar Hermano <i class="fa fa-floppy-o" aria-hidden="true"></i></button>
                        </li>
                    </ul>
                    <%
                            }
            ...
            <%
                if (request.getParameter("editar") != null) {
                    ...
                    try {
                        st.execute("UPDATE hermanos SET numero_hermano = '" + numero_hermano + "', nombre = '" + nombre + "', apellidos = '" + apellidos + "', dni = '" + dni + "', fecha_nacimiento = '" + fecha_nacimiento + "', telefono = '" + telefono + "', email = '" + email + "', provincia = '" + provincia + "', localidad = '" + localidad + "', direccion = '" + direccion + "', codigo_postal = '" + codigo_postal + "'"
                                + " WHERE id = '" + request.getParameter("id") + "';");
                        sesion.setAttribute("mensaje", "editar");
                        request.getRequestDispatcher("../hermanos/ficha.jsp?id=" + request.getParameter("id")).forward(request, response);
                    } catch (Exception e) {
                        out.print(e);
                    }
                }

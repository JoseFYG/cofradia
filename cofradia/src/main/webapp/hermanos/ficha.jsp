    ...
    <body style="background-color: #F39237;">
            ...
            <script>
                function editar() {
                    Swal.fire({
                        ...
                        text: "Se han aplicado los cambios en la ficha del hermano",
                        icon: "success"
                    });
                }
            </script>
            ...
            <div class="card text-center" style="width: 80%; margin: auto auto;">
                ...
                <div class="card-body">
                    <div class="row py-2">
                        ...
                        <div class="col-sm-6">
                            <b>Fecha de Nacimiento:</b> <%=fecha_nacimiento.split("-")[2]%>/<%=fecha_nacimiento.split("-")[1]%>/<%=fecha_nacimiento.split("-")[0]%>
                        </div>  
                    </div>
                    <div class="row py-2">
                        <div class="col-sm-6">
        ...
        <script>
            function baja() {
                Swal.fire({
                    title: "¿Estás seguro?",
                    text: "Vas a dar de baja a este hermano",
                    icon: "warning",
                    showCancelButton: true,
                    confirmButtonColor: "#3085d6",
                    cancelButtonColor: "#d33",
                    confirmButtonText: "<a href='../hermanos/baja.jsp?id=<%=request.getParameter("id")%>' style='color:white'>Dar de Baja</a>",

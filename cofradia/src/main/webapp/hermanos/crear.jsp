                    ...
                    <ul class="list-group list-group-light list-group-small">
                        ...
                        <li class="list-group-item px-3 py-3">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" value="<%=hoy%>">
                            </div>
                        </li>
                        <li class="list-group-item px-3 py-3">
                            <div class="form-group">
                        ...
                        <li class="list-group-item px-3 text-center">
                            <button type="submit" name="crear" class="btn btn-success px-5 py-3"><i class="fa-solid fa-floppy-disk mx-1"></i> Dar de Alta <i class="fa fa-floppy-o" aria-hidden="true"></i></button>
                        </li>
                    </ul>
                </form>
            </div>
                ...
                if (request.getParameter("crear") != null) {
                    ...
                    try {
                        st.execute("INSERT INTO hermanos (CIF, numero_hermano, nombre, apellidos, dni, fecha_nacimiento, telefono, email, provincia, localidad, direccion, codigo_postal) "
                                + "values "
                                + "('" + sesion.getAttribute("CIF") + "', '" + numero_hermano + "', '" + nombre + "', '" + apellidos + "', '" + dni + "', '" + fecha_nacimiento + "', '" + telefono + "', '" + email + "', '" + provincia + "', '" + localidad + "', '" + direccion + "', '" + codigo_postal + "');");
